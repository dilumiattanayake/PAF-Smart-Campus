              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button type="button" className="w-full bg-primary text-primary-foreground hover:bg-primary/90" onClick={handleGoogleSignIn}>
                  <svg aria-hidden="true" viewBox="0 0 24 24" className="mr-2 h-4 w-4" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path fill="#4A90E2" d="M6.42 13.92c-.2-.6-.32-1.23-.32-1.92s.12-1.32.32-1.92L3.08 7.5A9.94 9.94 0 0 0 2 12c0 1.61.39 3.13 1.08 4.5l3.34-2.58z" />
                    <path fill="#FBBC05" d="M12 5.98c1.47 0 2.79.5 3.83 1.48l2.87-2.87C16.95 2.96 14.7 2 12 2 8.08 2 4.72 4.23 3.08 7.5l3.34 2.58c.79-2.35 2.99-4.1 5.58-4.1z" />
                  </svg>
                  Sign In with Google
                </Button>
